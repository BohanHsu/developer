...
if __name__ == "__main__":
    ...
    for i in range(0,len(sents1)):
        ...
        totW1 = totW1 + len(sentence1)
        totW2 = totW2 + len(sentence2)
        parseing(sentence1,sentence2,grammar,lexical)
    
    print 'total number of []:', sbCount
    print 'total number of <>:', abCount
    print 'total number of word-<e> align:', wordEp
    print 'total number of <e>-word align:', epWord
    print 'total number of word 1:', totW1
    print 'total number of word 2:', totW2
    print 'precentage of word-<e>:=',wordEp,'/',totW1,'=', (float(wordEp)/float(totW1)) * 100, '%'
    print 'precentage of <e>-word>:=',epWord,'/',totW2 ,'=', (float(epWord)/float(totW2)) * 100, '%'
